...
export const TRADE_CATEGORY_OPTIONS: { value: TradeCategory; label: string }[] = [
  { value: "gros_oeuvre", label: "🏗️ Gros œuvre" }, { value: "charpente", label: "🪵 Charpente" },
  { value: "couverture", label: "🏠 Couverture" }, { value: "facade", label: "🧱 Façade" },
  { value: "isolation", label: "🌡️ Isolation" }, { value: "menuiseries_exterieures", label: "🚪 Menuiseries extérieures" },
  { value: "menuiserie_interieure", label: "🪚 Menuiserie intérieure" }, { value: "electricite", label: "⚡ Électricité" },
  { value: "photovoltaique", label: "☀️ Photovoltaïque" }, { value: "chauffage", label: "🔥 Chauffage" },
  { value: "pompes_a_chaleur", label: "♨️ Pompes à chaleur" }, { value: "ventilation", label: "🌬️ Ventilation" },
  { value: "plomberie", label: "🚿 Plomberie" }, { value: "salle_de_bains", label: "🚿 Salle de bains" },
  { value: "poeles_cheminees", label: "🔥 Poêles & cheminées" }, { value: "solaire_thermique", label: "☀️ Solaire thermique" },
  ...
  { value: "maitrise_oeuvre", label: "📐 Maîtrise d’œuvre" }, { value: "architecture", label: "🏛️ Architecture" },
